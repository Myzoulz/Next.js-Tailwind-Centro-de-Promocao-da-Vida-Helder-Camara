...
export const navItems: NavItem[] = [
    ...
    { label: "Educação", icon: BookOpen, imagem: "/imagesHero/educacao.jpeg", conteudo: "Por meio do reforço escolar, atendemos crianças até o 6º ano do Ensino Fundamental, oferecendo acompanhamento pedagógico que contribui para o fortalecimento da aprendizagem e o desenvolvimento de habilidades essenciais para sua trajetória escolar." },
