...
export const cardsContent: cardContent[] = [
    ...
    { titulo: "Oficina de Libras", descricao: "Aulas gratuitas de linguagem brasileira de sinais.", imagem: "/imagesCards/placeholder.png" },
    { titulo: "Ritimos", descricao: "Atividade física gratuita para a comunidade.", imagem: "/imagesCards/ritimos.jpeg" },
    { titulo: "Ceará sem Fome", descricao: "Fornecimento de 100 quentinhas diariamente para pessoas em situação de vulnerabilidade.", imagem: "/imagesCards/ceara-sem-fome.png" },
    { titulo: "Oficina de Corte e Costura", descricao: "Curso completo e gratuito para aprender a costurar do zero.", imagem: "/imagesCards/corte-e-costura.jpeg" },
    { titulo: "Fisioterapia", descricao: "Acompanhamento fisioterapico gratuito.", imagem: "/imagesCards/placeholder.png" },
    { titulo: "Cine Delas", descricao: "Cine clube feito especialmente para as mulheres.", imagem: "/imagesCards/cine-delas.jpg" }
];